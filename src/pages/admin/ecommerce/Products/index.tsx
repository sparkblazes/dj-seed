...
import {
  setFilters,
  setVisibleColumns,
} from "../../../../../redux/ecommerce/Products/productSlice";
...
const ProductCategoriesIndex: React.FC = () => {
  ...
  const handleImport = async (file: File) => {
    ...
    const res: any = await importProducts(formData);
  ...
  const handleExport = async () => {
    try {
      await exportProducts({
        uuids: data?.data.map((product) => product.id.toString()) || [],
      });
      ...
      setImportErrors([
        {
          row: "-",
          field: [{ attribute: "export", errors: ["Failed to export product"] }],
        },
      ]);
    }
  };
                  ...
                  actions={(row) => (
                    <>
                      <button
                        ...
                        onClick={() =>
                          navigate(`/ecommerce/product/edit/${row.id}`)
                        }
                      >
                        Edit
                      </button>
